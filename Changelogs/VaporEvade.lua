...
local function setTab(tabName)
    if tabName == "Changelog" then
        content.Text = "VaporEvade V1.0\n\nEnjoy using the best Evade script that's out there right now!\n\nGet this script viral, make content and tag #ProjectVapor #VaporEvade"
    end
    task.wait()
    updateScrollSize()
end
