...
local function setTab(tabName)
    if tabName == "Changelog" then
        content.Text = "VaporFindMark V1.0\n\n- Auto Win - Full automation for Find and Mark\n- Auto Table - Smart table management and automatic switching\n- Auto Server Hop - Automatic hopping to servers with more players\n- Auto Rewards - Automatic time reward claiming\n- Auto Daily Wheel - Automatic daily wheel spin\n- Auto Like Reward - Automatic like reward claiming\n- Auto Win Obby - Automatic obby completion to claim Rainbow Chair\n- Anti-AFK - Prevents idle disconnection"
    end
    task.wait()
    updateScrollSize()
end
