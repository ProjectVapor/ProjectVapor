...
local function setTab(tabName)
    if tabName == "Changelog" then
        content.Text = "VaporMvsdSpawner V1.1\n\n- Fixed the rarity's issue that was causing legendary items to be spawned as common rarity\n- Items are now also in order as you spawn them\n\nEnjoy using the best Mvsd script that's out there right now, which can spawn any of your dream mvsd items\n\nGet this script viral, make content and tag #ProjectVapor #VaporMvsdSpawner"
    end
    task.wait()
    updateScrollSize()
end
